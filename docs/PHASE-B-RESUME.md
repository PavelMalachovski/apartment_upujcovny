...
Branch `phaseB-migration`, PR #27 **open and out of draft**.
...
| 3 — `2026-08-13-phase-b3-light.md` | Reachable blacks: source fix, BVH sampler, GTAO, lightmap pilot | **Task 1 done with an open question**, 6 tasks left |
