...
Кнопка **«⌂ Макет»** включает режим кукольного домика: квартира целиком
с орбитальной камерой (мышь/палец — вращение, колесо/пинч — зум),
переключатель «1 этаж / Весь дом», **клик по полу опускает прямо в эту
точку квартиры**. Esc или «✕ Прогулка» — обратно к ходьбе.
