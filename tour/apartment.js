...
const APT = {
  ...
  groundZones: [
    ...
    { x1: 3.4, z1: 2.8, x2: 4.2, z2: 3.8, ramp: { axis: 'x', from: 4.2, to: 3.4, y0: 3.1, y1: 2.98 } }, // ступенька на террасу
    { x1: 0.2, z1: 0.5, x2: 4.2, z2: 6.6, y: 2.98 }                        // терраса
  ],
  ...
  roomLabels: [
    ...
    { x1: 0.2, z1: 0.5, x2: 4.2, z2: 6.6, y: 2.98, name: 'Терраса' }
  ],
  ...
  spawns: [
    ...
    { name: 'Терраса', x: 3.6, z: 3.3, yaw: Math.PI * 1.25, g: 2.98 }
  ]
};
