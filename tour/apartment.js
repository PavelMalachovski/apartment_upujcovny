...
const APT = {
  ...
  walls: [
    ...
    // Ограждение лестничного проёма (юг), с проходом на лестницу у запада
    { lvl: 'upper', x1: 12.9, z1: -0.6, x2: 15.6, z2: -0.6, h: 1.0, rail: true },
  ...
  furniture: [
    ...
    // ================= ВЕРХНИЙ УРОВЕНЬ =================
    // Холл
    { type: 'wardrobe', x: 11.8, z: 0.0, w: 0.65, d: 2.2, rot: Math.PI / 2, lvl: 'upper' },
    { type: 'plant', x: 15.2, z: 1.6, lvl: 'upper' },
  ...
  groundZones: [
    ...
    { x1: 4.2, z1: -2.0, x2: 12.2, z2: 6.6, y: 3.1 },                      // верхний уровень (запад)
    { x1: 12.2, z1: -0.6, x2: 15.6, z2: 6.6, y: 3.1 },                     // верхний уровень (восток, минус проём)
